...
<div class="container">
	<form action="" method="post">
		<div class="form-group">
			...
			<input type="text" name="nip" class="form-control" id="inputnip" maxlength="40" required autofocus>
			<small class="text-danger"><?= $nipErr == "" ? "":"* $nipErr " ?></small>
		</div>
		<div class="form-group">
			<label for="inputnama">Nama</label>
			<input type="nama" name="nama" class="form-control" id="inputnama" maxlength="30" required>
